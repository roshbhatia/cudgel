...
- [ ] T108 [P] [US3] Unit test: test_update_entity_summary in tests/test_graph_client.rs
- [ ] T109 [P] [US3] Unit test: test_get_entity_by_id in tests/test_graph_client.rs
- [ ] T110 [P] [US3] Unit test: test_query_parser_entity_description_intent in tests/test_graph_queries.rs
- [ ] T111 [P] [US3] Unit test: test_generate_entity_summary_with_code_snippet in tests/test_llm_integration.rs
- [ ] T112 [US3] Integration test: test_entity_summary_generation_workflow in tests/integration_tests.rs

### Implementation for User Story 3

**Entity Summary Management**:
- [ ] T113 [US3] Implement update_entity_summary() in src/graph/client.rs
- [ ] T114 [US3] Implement get_entity() by ID in src/graph/client.rs
...
- [ ] T117 [US3] Add entity description pattern regex to QueryParser in src/graph/query.rs
- [ ] T118 [US3] Implement execute_entity_description_query() in src/graph/query.rs
- [ ] T119 [US3] Handle case where entity has no summary (fetch from DB or generate on-demand) in src/graph/query.rs

**Integration**:
- [ ] T120 [US3] Add entity summary generation to build_from_index() pipeline in src/graph/builder.rs
- [ ] T121 [US3] Add entity description queries to query command handler in src/main.rs
